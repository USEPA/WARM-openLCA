...
import gov.epa.warm.rcp.utils.Preferences;
import gov.epa.warm.rcp.utils.ui.Controls;
...
class VsCpp10Message {
	...
	private static class Dialog extends FormDialog {
		...
		private String getMessage() {
			String message = "Warm contains a browser engine for the display "
					+ "of modern HTML pages. It requires the "
					+ "<a href=\"http://www.microsoft.com/en-us/download/details.aspx?id=14632\">"
					+ "Microsoft Visual C++ Runtime v10</a> to be installed on "
					+ "Windows 64bit which seems to be not the case on your "
					+ "system. In order to run WARM, it is necessary to install this runtime.";
			return message;
		}
